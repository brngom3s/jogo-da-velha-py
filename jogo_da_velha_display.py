...
app_x = Label(frame_esquerda, text="Jogador 1", height=1, relief="flat",
              anchor="center", font=("Courier 16 bold"), bg=roxoescuro, fg=branco)
app_x.place(x=40, y=200)

app_x_pontos = Label(frame_esquerda, text="0", height=1, relief="flat",
                     anchor="center", font=("Ivy 65 bold"), bg=roxoescuro, fg=branco)
...
def sair_jogo():
    # b_jogar1p.destroy()
    b_jogar2p.destroy()
    encerramento = Label(frame_meio, text="PROGRAMA FINALIZADO", width=37, anchor='center',
...
#################################### CONDIÇÕES DE VITÓRIA ###############################################
    ...
    def terminar():
        ...
        b_jogar1p = Button(frame_meio, command=jogar_denovo, text='Jogar Novamente!', height=1,  font=(
            'Ivy 10 bold'), overrelief=RIDGE, relief='raised', anchor='center', bg=preto, fg=laranjaclaro)
        b_jogar1p.place(x=140, y=450)
    ...
    b_0 = Button(frame_meio, command=lambda: controlar("1"), text="", width=5, height=2,  font=(
        "Ivy 20 bold"), overrelief=RIDGE, relief="raise", bg=quadrados, fg=preto)
...
b_jogar2p = Button(frame_meio, command=iniciar_jogo, text=' Iniciar Jogo', width=20, height=1,  font=(
    'Ivy 15 '), overrelief=RIDGE, relief='raised', bg=preto, fg=laranjaclaro)
